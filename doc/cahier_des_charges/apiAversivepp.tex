...
Concrètement dans un premier temps seuls les devices seront simulés. Donc seulement cette partie de l'API sera implémentée de manière "complète" dans API\_simulation. Nous pouvons cependant noter que l'interface d'\texttt{Aversive++} sera %presque (Clément) %
